...
namespace Depra.Data.Storage.Tests
{
    ...
    internal class FileDataStorageTests
    {
        ...
        private IDataDirectory _dataDirectory;
        ...
        public void WhenSavingData_AndStorageContainKey_ThenSuccess()
        {
            ...
            var fullFilePath = _dataDirectory.CombineFullFilePath(randomExistedDataName);
        ...
        public void WhenSavingData_AndStorageDoesntContainKey_ThenThrowError()
        {
            ...
            var fullFilePath = _dataDirectory.CombineFullFilePath(randomNonExistedDataName);
        ...
        private IDataStorage BuildDataStorage()
        {
            var serializer = new BinarySerializer();
            const SearchOption searchOptions = SearchOption.TopDirectoryOnly;
            _dataDirectory = new LocalFileBridge(DirectoryPath, FileFormat, serializer, searchOptions);
            
            var fileDataStorage = StandardDataStorageBuilder
                .Configure(_dataDirectory, builder => builder
                    .AddLoader(loader => loader.AddReader(new DataReader<TestData>(_dataDirectory)))
                    .AddSaver(saver => saver.AddWriter(new DataWriter<TestData>(_dataDirectory))))
                .Build();
        ...
        private void FreeResources()
        {
            ...
            foreach (var fullFilePath in filesForDelete.Select(fileName => _dataDirectory.CombineFullFilePath(fileName)))
            {
